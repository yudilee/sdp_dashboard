...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 animate-enter delay-200">
        ...
        <div>
            ...
            <!-- In Stock Breakdown -->
            <div class="bg-emerald-100 dark:bg-emerald-900/10 rounded-2xl shadow-sm dark:shadow-none border border-emerald-100 dark:border-emerald-900/50 p-6">
                <div class="flex items-center gap-2 mb-6 pb-4 border-b border-emerald-200/50 dark:border-slate-800">
                    <div class="p-2 bg-emerald-200 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-lg">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-amber-100 dark:bg-amber-900/10 rounded-2xl shadow-sm border border-amber-100 dark:border-amber-900/50 p-6">
                <div class="flex items-center gap-2 mb-6 pb-4 border-b border-amber-200/50 dark:border-slate-800">
                    <div class="p-2 bg-amber-200 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 rounded-lg">
            ...
            <!-- In Service Breakdown -->
             <div class="bg-red-100 dark:bg-red-900/10 rounded-2xl shadow-sm border border-red-100 dark:border-red-900/50 p-6">
                <div class="flex items-center gap-2 mb-6 pb-4 border-b border-red-200/50 dark:border-slate-800">
                    <div class="p-2 bg-red-200 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-lg">
